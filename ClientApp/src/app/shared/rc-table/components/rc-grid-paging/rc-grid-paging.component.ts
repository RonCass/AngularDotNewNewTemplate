...
@Component({
  selector: 'app-rc-grid-paging',
  templateUrl: './rc-grid-paging.component.html',
  styleUrls: ['./rc-grid-paging.component.css']
})
export class RCGridPagingComponent implements OnInit {
